...
UiPath aggregates custom build _**AIForged**_** ** activities that are available in the “Manage Packages” tab in _**UiPath Studio**_.
...
The name of the package is: _**AIForged** _ by **AIForged**
