...
* Any **Custom Code** logic that places a **Parameter** in the **Verification** state. Refer to [Custom Service Code](../../human-in-the-loop/custom-service-code//index.md) for more information.
