...
| AccessKey               | ![](<../../.gitbook/assets/image (7) (2).png>)                     | Optional      | Override the Access Key to the configured Tesseract cloud service.                                                           |
| BaseURL                 | ![](<../../.gitbook/assets/image (7) (2).png>)                     | Optional      | Override the URL to the configured Tesseract cloud service.                                                                  |
| BatchSize               | ![](<../../.gitbook/assets/image (14) (6).png>)                    | Hidden        | Processing batch size.                                                                                                       |
| CheckElectronic         | ![](<../../.gitbook/assets/image (15) (1) (3).png>)                | Optional      | Check if the document is electronic and extract text from there.                                                             |
