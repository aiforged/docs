...
2. **Set Up the Classifier**
   * Open the AIForged Classifier wizard within your agent.\
     ![](<../../.gitbook/assets/image (6) (1).png>) or ![](<../../.gitbook/assets/image (9) (1).png>)\
...
4. **Train the Classifier**
   * Start the training process using your uploaded examples and defined categories by clicking on the train ![](<../../.gitbook/assets/image (13) (1).png>) button.\
