...
1. In the **Google Invoice Parser Service** click on **Inbox** in the App Bar.
...
1. In the **Google Identity Service** click on **Outbox** button.
2. You can view the **Processing** results in the Status.
