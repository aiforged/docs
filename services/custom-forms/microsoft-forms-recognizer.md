...
| EnableSelectionMarks              | ![](<../../.gitbook/assets/image (15) (1) (5).png>)                | Optional      | Specifies whether the service should save any selection marks returned by MS Form API call.                                                                                                          |
...
| MatchTablesWithSameColumnCount    | ![](<../../.gitbook/assets/image (1) (1) (3) (1) (1) (2) (5).png>) |               | Try to match a table to an existing table parameter definition by using column counts only. This is especially useful when tables span multiple pages without repeating headers on each page.        |
...
| SaveOCRLayout                     | ![](<../../.gitbook/assets/image (1) (1) (3) (1) (1) (2) (3).png>) |               | Save the OCR layout of the documents (Lines, words, etc.).                                                                                                                                           |
