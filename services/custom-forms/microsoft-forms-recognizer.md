...
| EnableSelectionMarks              | ![](<../../.gitbook/assets/image (15) (6).png>)            | Optional      | Specifies whether the service should save any selection marks returned by MS Form API call.                                                                                                          |
...
| MatchTablesWithSameColumnCount    | ![](<../../.gitbook/assets/image (1) (1) (3) (1) (4).png>) |               | Try to match a table to an existing table parameter definition by using column counts only. This is especially useful when tables span multiple pages without repeating headers on each page.        |
...
| SaveOCRLayout                     | ![](<../../.gitbook/assets/image (1) (1) (3) (1) (1).png>) |               | Save the OCR layout of the documents (Lines, words, etc.).                                                                                                                                           |
